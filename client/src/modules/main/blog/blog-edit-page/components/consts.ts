...
export const TOAST_ERROR_FORMAT = "Zły format pliku";

export const FILE_FORMAT = "image/jpeg";
export const TOAST_SUCCESS_EDITED = "Artyłu został zedytowany poprawnie!";
